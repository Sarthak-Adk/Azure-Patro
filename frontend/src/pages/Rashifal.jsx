...
export default function Rashifal() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 flex flex-col lg:flex-row gap-6">
      ...
      <div className="flex-1">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {horoscopes.map((item, index) => (
            <div
              key={index}
              className="bg-white shadow-md p-5 rounded-xl border border-gray-200 hover:shadow-lg transition"
            >
              <div className="flex items-center gap-3 mb-2">
                <img src={item.img} alt={item.sign} className="w-12 h-12 rounded-lg" />
                <h2 className="text-xl font-bold text-red-600">{item.sign}</h2>
              </div>
      ...
      {/* Sidebar Section */}
      <aside className="w-full lg:w-1/3 bg-white p-5 shadow-md rounded-xl border border-gray-200 lg:sticky lg:top-4 self-start">
        <h3 className="text-lg font-bold text-gray-700 mb-3">LATEST NEWS</h3>
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm">17m ago</p>
            </div>
          </div>
           <div className="flex items-center gap-3 mt-4">
            <img
